...
public class AnaylizeFileRecv {
     ...
     */
    public void makeWatch(final String filepath, FileAnaylizeService fileAnaylizeService) {
        try {
            initMethodMap();
    ...
    private String getDataSetCodeFormFile(String path) throws Exception {
        ...
        // 读取数据文件中的数据集标识
        String filePath = userHomePath + File.separator + "recv" + File.separator + DateUtil.today() + File.separator + fileName.split("\\.")[0];
    ...
    private void localize(HashMap<String, Object> paraMap) throws Exception {
        ...
        if (null == fileName || "".equals(fileName)) {
            ...
            filePath = userHomePath + File.separator + "recv" + File.separator + DateUtil.today();
    ...
    private void receiveFile(String path, String flag) throws Exception {
        ...
        //本地存储文件的路径
        String localFilePath = userHomePath + File.separator + "recv" + File.separator + DateUtil.today();
        //本地化记录
...
//        unCompressZip(hmPara);
    ...
    private void processFieldSet(String lineValue, Co_ToExData co_ToExData, String dsType, String dsFlag,
                                 String errorFileName, int flagNum, ParaTransportVO pvo, List<Co_TxtAnalyze> co_TxtAnalyzs, String
    ...
    //横向生成excel
    private boolean genExcelRowAndCell(String
                                               filename, List<Co_ToExData> co_ToExDatas, List<Co_TxtAnalyze> co_txtAnalyzes) {
        ...
        try {
            ...
            //标题字体
            org.apache.poi.ss.usermodel.Font titleFont = sxssfWorkbook.createFont();
            titleFont.setFontName("黑体");
            titleFont.setFontHeightInPoints((short) 12);
            titleFont.setColor(org.apache.poi.ss.usermodel.Font.COLOR_RED);//红色
            ...
            //正文字体
            org.apache.poi.ss.usermodel.Font font = sxssfWorkbook.createFont();
            font.setFontName("黑体");
